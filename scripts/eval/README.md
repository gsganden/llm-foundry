...
>
    label: hellaswag
    dataset_uri: scripts/eval/local_data/language_understanding/hellaswag.jsonl # ADD YOUR OWN DATASET URI
    num_fewshot:
    - 0
    - 1
    - 5
...
>
    label: winograd
    dataset_uri: scripts/eval/local_data/language_understanding/winograd_wsc.jsonl
    num_fewshot:
    - 0
    - 1
    - 5
